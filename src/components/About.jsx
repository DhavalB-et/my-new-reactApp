  ...
  return (
    <section id="about" className="pt-20 pb-7 bg-[#f2f8fc] text-center px-4">
      ...
      <p className="max-w-3xl mx-auto text-gray-700 mb-8">
       We’re Kanaiya Films, a passionate team of wedding photographers dedicated to capturing real emotions and unscripted beauty. Every couple has a story worth telling — through tears, laughter, and all the little details in between.
